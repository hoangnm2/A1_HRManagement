...
public class DBUtil {
	...
	public Connection getConnection() throws SQLException, ClassNotFoundException {
		...
		String driver = dbProps.getProperty("MYSQL_DB_DRIVER");
		String urlString = dbProps.getProperty("MYSQL_DB_URL");
		
		Properties connectionProps = new Properties();
		connectionProps.put("user", this.dbProps.getProperty("MYSQL_DB_USERNAME"));
		connectionProps.put("password", this.dbProps.getProperty("MYSQL_DB_PASSWORD"));
